        ...
        >
              ...
              <div>
                <div className="flex justify-between flex-wrap">
                  <div className="flex gap-x-2">
                    ...
                    <StarRating data={hotel.star_rating} />
                  </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full lg:w-4/5 py-5">
              ...
              <p>
                Couples in particular like the location – they rated it for a
                two-person trip.
              </p>
              <div className="mt-2">
            ...
            <div className="w-full lg:w-1/5">
              <div className="text-black flex flex-col gap-y-2.5 p-2">
                ...
                <div className="flex items-center text-2xl">
                  ...
                  <h2 className="text-sm w-5/6">{hotel.desc_short}</h2>
                </div>
                <div className="flex items-center text-2xl">
          ...
          <div className="mt-5 border-t border-current">
            <div className="my-2.5 w-full">
              ...
              <RoomHotel hotel_id={hotel.hotel_id || id} />
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-max transform overflow-hidden rounded-2xl bg-white shadow-xl transition-all">
                    <div>
